...
namespace Week11_NorthwindConsole.Model
{
    public partial class NWConsole_48_AMSContext : DbContext
    {
        public NWConsole_48_AMSContext()
        {
        }

        public NWConsole_48_AMSContext(DbContextOptions<NWConsole_48_AMSContext> options)
            : base(options)
        {
        }
